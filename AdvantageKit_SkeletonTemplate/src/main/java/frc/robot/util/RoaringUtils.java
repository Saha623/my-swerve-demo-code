...
public class RoaringUtils {
  ...
  public static class GyroUtils {
    public static double WrapAngleDegreesHalf(double _angle) {
      ...
      if (angle
          == 360) { // Handle this case separately to avoid floating point errors with the floor
    ...
    public static double WrapAngleDegrees180(double _angle) {
      ...
      if (_angle
          == 180) { // Handle this case separately to avoid floating point errors with the floor
        // after the division in the case below
        return 0.0;
      } else if (_angle > 180) {
